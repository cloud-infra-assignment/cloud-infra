...
# Reference: https://github.com/kubernetes-sigs/aws-load-balancer-controller/blob/v2.14.1/docs/install/iam_policy.json
...
# Attach managed policy to ALB controller role
...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  depends_on = [kubernetes_storage_class.ebs_gp3_default, aws_iam_role_policy_attachment.alb_controller]
}
